...
namespace NVIDIA.Flex
{
    public static class FlexUtils
    {
        ...
        public static void SafeFastCopy<T>(T[] source, IntPtr destination) where T : struct // and vice versa
        {
        ...
        public static void SafeFastCopy<T>(IntPtr source, T[] destination) where T : struct // all this does is take the information from a pointer to a structure
        {
